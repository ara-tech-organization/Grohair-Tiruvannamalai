        ...
        <div className="footer__top">
          ...
          <div>
            ...
            <div className="footer__socials">
              ...
              <a href={WHATSAPP} target="_blank" rel="noopener noreferrer" className="footer__social" aria-label="WhatsApp">
                {/* WhatsApp SVG */}
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <a href={GOOGLE_MAPS} target="_blank" rel="noopener noreferrer" className="footer__contact-item footer__contact-link">
              <MapPin size={14} className="footer__contact-icon" />
              <span className="footer__contact-text">
                Second Floor, No.1551, Vellore - Thoothukudi Hwy,<br />
                above Reliance Digital, Thendral Nagar,<br />
                Vengikkal, Tiruvannamalai,<br />
                Tamil Nadu 606604
              </span>
            </a>
            <a href="tel:+917599056789" className="footer__contact-item footer__contact-link">
              <Phone size={14} className="footer__contact-icon" />
              <span className="footer__contact-text">+91 75990 56789</span>
            </a>
            <a href="mailto:tiruvannamalai@adgrohair.com" className="footer__contact-item footer__contact-link">
